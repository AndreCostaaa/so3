...
void vuihandler_probe(struct vbus_device *vdev)
{
	...
	vuihandler_priv->vuihandler.rx_ring_ref =
		vbus_grant_ring(vdev, phys_to_pfn(virt_to_phys_pt((addr_t) vuihandler_priv->vuihandler.rx_ring.sring)));
	...
	vuihandler_priv->vuihandler.tx_ring_ref =
		vbus_grant_ring(vdev, phys_to_pfn(virt_to_phys_pt((addr_t) vuihandler_priv->vuihandler.tx_ring.sring)));
...
vdrvfront_t vuihandlerdrv = { .probe = vuihandler_probe,
